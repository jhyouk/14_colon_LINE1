...
(samtools mpileup -B -Q 20 -q 20 -f /home/users/jhyouk/99_reference/human/GRCh37/human_g1k_v37.fasta /home/users/team_projects/NCC_YJCha/02_bam/$1.s.md.bam -o $1.mpileup) &>> $log || { c=$?;echo "Error";exit $c; }
echo "done" >> $log
fi
