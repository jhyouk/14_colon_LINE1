...
if __name__ == '__main__':
	...
	parser.add_argument("-p","--PositionList", type=str, help="Position list for evaluation. Default('/home/users/sypark/01_Python_files/bamqc/src/hg19_aeg.sites.2015_08_chrall_snp_cds_cut_0.1_0.9.txt.fi.segdup.pos')", default='/home/users/sypark/01_Python_files/bamqc/src/hg19_aeg.sites.2015_08_chrall_snp_cds_cut_0.1_0.9.txt.fi.segdup.pos')
	parser.add_argument("-r","--reference", type=str, help="Reference fasta which was used for alignment. Default('/home/users/data/01_reference/human_g1k_v37/human_g1k_v37.fasta')", default='/home/users/data/01_reference/human_g1k_v37/human_g1k_v37.fasta')
	parser.add_argument("-s","--ScriptDir",type=str,help="The location of scripts for this tool. Default('/home/users/sypark/01_Python_files/bamqc/src')", default='/home/users/sypark/01_Python_files/bamqc/src')
